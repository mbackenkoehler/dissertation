...
More recently, a scheme based on the Kullback-Leibler divergence between the approximate and the original system has been proposed for \acp{DTMC} \parencite{geiger2014optimal}.
