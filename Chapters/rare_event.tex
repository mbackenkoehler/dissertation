...
In the second part, we take a look at a slightly more involved model -- the toggle switch.
...
\begin{model}[Toggle Switch using Hill functions]\label{model:hill_toggle_rare}
