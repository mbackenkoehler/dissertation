...
We implemented and solved the \ac{SDP} programs described above using optimization suite \acsfont{MOSEK}~\parencite{mosek} (version 9.1.2) via the \acsfont{CVXPY}
