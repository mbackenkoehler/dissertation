...
to moment matrices in form of a positive semi-definite constraint \cite{parrilo2003semidefinite}.\graffito{This constraint is valid for general positive measures --- even if they do not model probabilities.}
