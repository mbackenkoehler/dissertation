...
This restriction is only due to the simplification of only haveing to record one value for each tuple of moment vector $m$ and weighting coefficient $\lambda$.
