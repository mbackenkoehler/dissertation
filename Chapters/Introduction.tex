...
For example, chemical concentrations can usually be treated as continuous if the number of molecules in a given volume is large.\marginpar{In many chemical experiments, for example, huge numbers of molecules are present.}
