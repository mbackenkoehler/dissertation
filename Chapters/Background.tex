...
\acp{ODE} for the expected values of an \ac{MPM} can be derived using its generator.\marginpar{This is called the \emph{drift} (see \autoref{sec:statagg:lyapunov}).}
