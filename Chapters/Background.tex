...
A \emph{stochastic process} is a parameterized collection of random variables $\{X_t\}_{t\in T}$ defined on some probability space $(\Omega, \mathcal{F}, P)$.\marginpar{For more information on stochastic processes \citet{oksendal2013stochastic} is an excellent starting point.}
...
\section{Stationary Distribution}\label{sec:statagg:stationary_dist}
Assuming
% irreducibility and 
ergodicity  
