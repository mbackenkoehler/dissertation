\chapter{Analysis under Terminal Constraints}\label{sec:bridging}
...
\paragraph{Reachibility in Verification}
...
To analyze the switching, we choose the transition from\marginpar{Variable order: $P_1$, $P_2$, $D$, $D.P_1$, $D.P_2$.}
$$ x_{1} = (32, 0, 0, 0, 1) 
\quad\text{to}\quad
 x_2 = (0, 32, 0, 1, 0) $$
...
\begin{model}[Toggle Switch using Hill functions]
