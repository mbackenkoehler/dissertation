...
The problem considered in this chapter can be interpreted as an instance of a model checking problem \parencite{brim2013model,BENTRIOU2021191}.
...
However,  they used a given linearly biased \ac{MPM} model to obtain a truncation. A general strategy to compute an appropriate biasing was not proposed.
