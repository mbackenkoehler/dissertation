...
The analysis as a Jupyter notebook is made available online\marginpar{\url{https://www.github.com/mbackenkoehler/mjp_bridging}}.
...
\begin{figure}
	...
	\caption[The expected occupation time (Toggle Switch)]{The expected occupation time (excluding initial and terminal states) for the switching problem of the toggle switch using Hill-type functions. The bridging problem is from initial $(0,120)$ to a first passage of $(120, 0)$ in
    $t\in [0,10]$.}
