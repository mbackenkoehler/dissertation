...
For example, time-series data of protein levels is available while the mRNA concentration is not  \parencite{adan2017flow,huang2016reconstructing}.
...
lumped approximations of the $P_1$-$P_2$ phase space upon each other. Special treatment of \ac{DNA} states is common for such models \parencite{lapin2011shave}. 
...
This is widely used to describe the spreading of an epidemic such as the current COVID-19 outbreak~\parencite{he2020seir,grossmann2020importance}.
