    ...
    \begin{figure}
        ...
        \begin{columns}
            ...
            \begin{column}{.33\paperwidth}
                \vspace{-5mm}
                $$ {\scriptstyle X\rightarrow \varnothing, \quad \alpha_1(x)=0.1 \cdot x } $$
                $$ {\scriptstyle \varnothing\rightarrow X, \quad \alpha_2(x) = 10 } $$
                \vfill
            \end{column}
...
\multipleframe
\foreach \n in {1,...,7}{
\begin{frame}{Stationary Distribution}{Examples}
    \begin{figure}
        \centering
